...
export const WorkImage = () => {
    ...
    const getCoordinates = (event: MouseEvent | TouchEvent) => {
        ...
        const viewportOffsetLeft = target.getBoundingClientRect().left;
        const viewportOffsetTop = target.getBoundingClientRect().top + window.scrollY;
        ...
        return {
            x: bitwiseFloor(x - viewportOffsetLeft),
            y: bitwiseFloor(y - viewportOffsetTop),
        };
    };
    ...
    useEffect(() => {
        if (!canvasRef.current || !drawAreaRef.current) {
            return;
        }
        onWindowResize();
    }, []);
    ...
    useEffect(() => {
        ...
        canvas.addEventListener('mousedown', startPaint, { capture: false, passive: false });
        canvas.addEventListener('touchstart', startPaint, { capture: false, passive: false });
        return () => {
            canvas.removeEventListener('mousedown', startPaint, { capture: false, passive: false });
            canvas.removeEventListener('touchstart', startPaint, { capture: false, passive: false });
        };
    }, [startPaint]);
    ...
    useEffect(() => {
        const canvas: any = canvasRef.current;
        canvas.addEventListener('mousemove', paint, { capture: false, passive: false });
        canvas.addEventListener('touchmove', paint, { capture: false, passive: false });
        return () => {
            canvas.removeEventListener('mousemove', paint, { capture: false, passive: false });
            canvas.removeEventListener('touchmove', paint, { capture: false, passive: false });
        };
    }, [paint]);
    ...
    useEffect(() => {
        const canvas: any = canvasRef.current;
        canvas.addEventListener('mouseup', exitPaint, { capture: false, passive: false });
        // canvas.addEventListener('mouseleave', exitPaint, { capture: false, passive: false });
        canvas.addEventListener('touchend', exitPaint, { capture: false, passive: false });
        return () => {
            canvas.removeEventListener('mouseup', exitPaint, { capture: false, passive: false });
            // canvas.removeEventListener('mouseleave', exitPaint, { capture: false, passive: false });
            canvas.removeEventListener('touchend', exitPaint, { capture: false, passive: false });
        };
    }, [exitPaint]);
    ...
    return (
        <div className={styles.workImageWrapper}>
            <div className={styles.workImageWrapper__offset}>
                {/* plant */}
                <svg
                ...
                >
                    <g data-name="Warstwa 2">
                        <g data-name="Warstwa 1">
                            <circle cx="41" cy="41" r="41" fill="#5d0e2c" />
                            <path fill="none" d="M22 24h39v38a7 7 0 01-7 7H29a7 7 0 01-7-7V24z" />
                            <path fill="none" stroke="#fff" strokeWidth="2" d="M24 25h35a1 1 0 011 1v36a6 6 0 01-6 6H29a6 6 0 01-6-6V26a1 1 0 011-1z" />
                            <path fill="none" d="M21 18h41a4 4 0 014 4 4 4 0 01-4 4H21a4 4 0 01-4-4 4 4 0 014-4z" />
                            <path fill="none" stroke="#fff" strokeWidth="2" d="M21 19h41a3 3 0 013 3h0a3 3 0 01-3 3H21a3 3 0 01-3-3h0a3 3 0 013-3z" />
                            <path fill="none" d="M34 13h15v6H34z" />
                            <path fill="#fff" d="M36 15v2h11v-2H36m-2-2h15v6H34z" />
                            <path fill="none" stroke="#fff" strokeWidth="2" d="M42 34v24M34 34v24M50 34v24" />
                            <circle cx="41" cy="41" r="41" fill="transparent" onClick={clearCanvas} />
                        </g>
                    </g>
                </svg>
                {/* CANVAS */}
